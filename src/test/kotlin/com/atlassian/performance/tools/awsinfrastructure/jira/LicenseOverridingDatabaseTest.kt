...
import com.atlassian.performance.tools.awsinfrastructure.UnimplementedSshConnection
...
class LicenseOverridingDatabaseTest {
    ...
    private fun setUp(
        ...
        return DatabaseStartTest(
            testedDatabase = LicenseOverridingDatabase(
    ...
    private data class DatabaseStartTest(
        val testedDatabase: LicenseOverridingDatabase,
        val underlyingDatabase: RememberingDatabase,
